...
import {shortenAddress} from '../utilities/reduceAccount';
        ...
        <div className='flex w-full justify-center items-center'>
            <div className='flex mf:flex-row flex-col items-start justify-between md: p-20 py-12 px-4'>
                <div className=' flex flex-1 justify-start flex-col mf:mr-10'>
                    ...
                    <div className='grid sm:grid-cols-3 grid-cols-2 w-full mt-10 shadow-xl shadow-black '>
                        <div className={`rounded-tl-2xl shadow-inner shadow-black ${commonStyles}`}>
                            Speed
                        </div>
                        <div className={commonStyles }>Dedication</div>
                        <div className={`rounded-tr-2xl shadow-inner shadow-black ${commonStyles}`}>
                            Security
                        </div>
                        <div className={`rounded-bl-2xl shadow-inner shadow-black ${commonStyles}`}>
                            Reliability
                        </div>
                        <div className={commonStyles}>Trust</div>
                        <div className={`rounded-br-2xl shadow-inner shadow-black ${commonStyles}`}>
                            Borderless
                        </div>
                    </div>
                </div>
                <div className='flex-col flex flex-1 items-center justify-start w-full mf:mt-0 mt-10'>
                    <div className='p-3 justify-end items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 eth-card blue-glassmorphism shadow-xl shadow-black'>
                        <div className='flex justify-between flex-col h-full'>
                            <div className='flex justify-between items-start'>
                                <div className='w-10 h-10 rounded-full border-2 border-white flex justify-center item-center py-2 px-2 shadow-xl shadow-black'>
                                    <SiEthereum fontSize={21} color='#9dc219' />
                                </div>
